...
const niveles = [
    {nombre: "Enemigo Novato", vida: 100, daño: 5, sprite: "assets/Fase1-level1.png", escala: 3.5, ancho: 64,
        alto: 64, fase:"PRINCIPIANTE"},
    {nombre: "Enemigo Salvaje", vida: 150, daño: 10, sprite: "assets/Fase1-level2.png", escala: 4, ancho: 64,
        alto: 64, fase:"PRINCIPIANTE"},
    {nombre: "Enemigo Legendario", vida: 200, daño: 15, sprite: "assets/Fase1-level3.png", escala: 4.5, ancho: 64,
        alto: 64, fase:"PRINCIPIANTE"},

    {nombre: "Enemigo Penudo", vida: 100, daño: 5, sprite: "assets/Fase2-level1.png", escala: 3.5, ancho: 64,
        alto: 64, fase:"INTERMEDIO"},
    {nombre: "Enemigo Mas Penudo", vida: 150, daño: 10, sprite: "assets/Fase2-level2.png", escala: 2.6, ancho: 64,
        alto: 75, fase:"INTERMEDIO"},
    {nombre: "Enemigo Ultra Penudo", vida: 200, daño: 15, sprite: "assets/Fase2-level3.png", escala: 1.9, ancho: 128,
        alto: 128, fase:"INTERMEDIO"},

    
    {nombre: "Enemigo Cabron", vida: 100, daño: 5, sprite: "assets/Fase3-level1.png", escala: 3.4, ancho: 64,
        alto: 64, fase:"AVANZADO"},
    {nombre: "Enemigo Cabronazo", vida: 150, daño: 10, sprite: "assets/Fase3-level2.png", escala: 2, ancho: 128,
        alto: 128, fase:"AVANZADO"},
    {nombre: "Enemigo Ultra Cabron", vida: 200, daño: 15, sprite: "assets/Fase3-level3.png", escala: 3.5, ancho: 64,
        alto: 64, fase:"AVANZADO"},
];
...
function cargarNivel() {
    ...
    enemigoSprite.style.setProperty("--ancho", nivel.ancho + "px");
    enemigoSprite.style.setProperty("--alto", nivel.alto + "px"); 
